package tr.org.liderahenk.userprivilege.commands;
...
public class UserPrivilegeCommand implements ICommand {

	private Logger logger = LoggerFactory.getLogger(UserPrivilegeCommand.class);
